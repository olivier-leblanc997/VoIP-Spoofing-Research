...
**Note:** This repository does not provide operational scripts or exploits. Instead, it documents the concepts, workflows, and tooling that malicious actors might use, including a SIP provider setup hosted on [sip24.cc](https://sip24.cc) or [trunk-voice.com](https://trunk-voice.com). This allows safe research and experimentation aimed at disrupting scam networks.
